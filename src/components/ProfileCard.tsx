                    ...
                    {isExpanded && (
                        ...
                        >
                            <div className="mt-4 pt-4 border-t border-white/5">
                                ...
                                >
                                    <span className="text-sm text-zinc-500">WLD Balance</span>
                                ...
                                >
                                    ...
                                    <motion.button
                                        ...
                                        className="shrink-0 flex items-center justify-center gap-1.5 py-2 px-3 glass rounded-xl text-zinc-400 hover:text-red-400 hover:bg-red-500/10 transition-colors text-sm font-semibold"
                                    >
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="text-xs text-white font-medium">World Chain</p>
                                            <p className="text-[10px] text-zinc-500">Chain ID: 480</p>
                                        </div>
                                    </div>
